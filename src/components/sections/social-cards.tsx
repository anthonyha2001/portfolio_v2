...
export function SocialCards() {
  return (
    <div className="mb-12">
      <h2 className="text-2xl md:text-3xl font-display font-bold text-dark text-center mb-2">
        Follow Me
      </h2>
      <p className="text-gray text-center mb-8 font-body">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {socialNetworks.map((network) => (
          <Link
            ...
            className="flex flex-col items-center justify-center p-5 bg-white rounded-xl border border-gray-100 hover:border-accent/70 hover:shadow-lg transition-all duration-300 group"
          >
            <div className="text-gray group-hover:text-accent transition-colors mb-3">
              {icons[network.icon]}
            </div>
            <span className="font-display font-semibold text-sm md:text-base text-dark group-hover:text-accent transition-colors">
              {network.name}
            </span>
          </Link>
        ))}
